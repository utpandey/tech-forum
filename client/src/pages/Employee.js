...
function Employee() {
	...
	let id = 0;
	return (
		<div className="employee__cont">
			<div className="employee__cont__headerCont">
				<h1 className="employee__cont__headerCont__title">Employees</h1>
				<h1 className="employee__cont__headerCont__info">Dashboard / Employees</h1>
			</div>
			<div className="employee__cont__mainCont">
				<button className="employee__cont__mainCont__btn" onClick={() => setModal((prevValue) => !prevValue)}>
					+ Add Employee
				</button>
			...
			{showModal && <AddEmployee showModal={showModal} setModal={setModal} />}
		</div>
	);
}
